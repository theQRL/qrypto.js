 ...
 * Reads: /tmp/goqrllib_mldsa87_pk.bin, /tmp/goqrllib_mldsa87_sig.bin, /tmp/goqrllib_mldsa87_msg.bin, /tmp/goqrllib_mldsa87_ctx.bin
 */
...
const pk = readFileSync('/tmp/goqrllib_mldsa87_pk.bin');
const sig = readFileSync('/tmp/goqrllib_mldsa87_sig.bin');
const msg = readFileSync('/tmp/goqrllib_mldsa87_msg.bin');
const ctx = readFileSync('/tmp/goqrllib_mldsa87_ctx.bin');
