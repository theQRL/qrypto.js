 ...
 * Reads: $TMPDIR/qrypto_cross_verify/goqrllib_dilithium5_{pk,sig,msg}.bin
 */
...
const pk = readFileSync(join(outputDir, 'goqrllib_dilithium5_pk.bin'));
const sig = readFileSync(join(outputDir, 'goqrllib_dilithium5_sig.bin'));
const msg = readFileSync(join(outputDir, 'goqrllib_dilithium5_msg.bin'));
